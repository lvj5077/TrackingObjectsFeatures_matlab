...
for i = 1:secNum
    ...
    MeanresultsMm(i) = mean(abs(vecnorm([results(:,i,1),results(:,i,2),results(:,i,3)]' )-gt_d(i)));
    MeanresultsMstd(i) = std(abs(vecnorm([results(:,i,1),results(:,i,2),results(:,i,3)]' )-gt_d(i)));
